...
import 'dart:async';
import 'dart:convert';
import 'package:capstoneapp/screen/collectorside/collectordetails.dart';
...
String _estimatedTime = ''; 
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                    builder: (_) => CollectorPointDetails(collectionPoint: ''),
                  ),
                  (route) => false,
                );
                print('Image tapped!');
 ...
 Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>CollectorPointDetails(collectionPoint: '',)), (route) => false);
